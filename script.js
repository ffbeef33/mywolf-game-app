document.addEventListener('DOMContentLoaded', function() {
  ...
  // --- Xử lý đăng nhập người chơi (giữ nguyên logic, thêm xử lý lỗi) ---
  const handleLogin = () => {
  ...
  // --- Xử lý đăng nhập quản trò (giữ nguyên logic) ---
  ...
  adminPassword.addEventListener('keypress', (e) => { if (e.key === 'Enter') adminButton.click(); });
});